...
/**
 * Created by ccl on 2017/12/21.
 * Health monitor uses BLE communications.
 * And this service class is a demo of Bluetooth device scanning,Bluetooth service connection and Bluetooth device data communication.
 * You can follow this demo to build your own code about Bluetooth.
 * You have to pay attention to the main code In this class are the parts marked "TODO" .
 */
