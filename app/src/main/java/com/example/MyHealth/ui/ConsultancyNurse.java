...
public class ConsultancyNurse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordButton.setOnRecordClickListener(new OnRecordClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ConsultancyNurse.this, "RECORD BUTTON CLICKED", Toast.LENGTH_SHORT).show();
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                Toast.makeText(ConsultancyNurse.this, "OnStartRecord", Toast.LENGTH_SHORT).show();
            ...
            public void onCancel() {
                Toast.makeText(ConsultancyNurse.this, "onCancel", Toast.LENGTH_SHORT).show();
            ...
            public void onFinish(long recordTime) {
                ...
                Toast.makeText(ConsultancyNurse.this, "onFinishRecord - Recorded Time is: " + time, Toast.LENGTH_SHORT).show();
            ...
            public void onLessThanSecond() {
                Toast.makeText(ConsultancyNurse.this, "OnLessThanSecond", Toast.LENGTH_SHORT).show();
