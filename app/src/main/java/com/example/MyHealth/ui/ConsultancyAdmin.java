...
import com.example.androidscreenrecorder.ScreenrecorderActivity;
...
// doc's consult screen. he can add additional notes but the rest of the fields should be loaded from patient's entry which will now be mudb
public class ConsultancyAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultancy_admin);

        mImageView = findViewById(R.id.consultImage);
        mCaptureBtn = findViewById(R.id.capture_image_consult);
        recorderBtn = findViewById(R.id.screenrecBtn);
      ...
      //  button = (Button) findViewById(R.id.consultancyButton);
        ...
        recordButton.setOnRecordClickListener(new OnRecordClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ConsultancyAdmin.this, "RECORD BUTTON CLICKED", Toast.LENGTH_SHORT).show();
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                Toast.makeText(ConsultancyAdmin.this, "OnStartRecord", Toast.LENGTH_SHORT).show();
            ...
            public void onCancel() {
                Toast.makeText(ConsultancyAdmin.this, "onCancel", Toast.LENGTH_SHORT).show();
            ...
            public void onFinish(long recordTime) {
                ...
                Toast.makeText(ConsultancyAdmin.this, "onFinishRecord - Recorded Time is: " + time, Toast.LENGTH_SHORT).show();
            ...
            public void onLessThanSecond() {
                Toast.makeText(ConsultancyAdmin.this, "OnLessThanSecond", Toast.LENGTH_SHORT).show();
   ...
   //     autoCompleteTextView.setText(arrayAdapter.getItem(0).toString(), false);
    ...
    private void setUpRecording(){
        ...
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "TransMed/Media/Recordings");
